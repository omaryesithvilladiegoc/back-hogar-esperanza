...
export class Campaign {
  ...
  @ApiProperty({
    ...
    example: 'ebd7f6a3-5d33-487a-bc8f-4b7fa29e4c6b',
  })
  id: string = uuid();
  ...
  @ApiProperty({
    ...
    example: 'Recaudación para el Hogar Esperanza',
  })
  name: string;
  ...
  @ApiProperty({
    ...
    example:
      'Nuestra campaña busca recaudar fondos para mejorar las instalaciones del hogar.',
  })
  description: string;
